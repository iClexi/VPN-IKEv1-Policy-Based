...
4. Como el tráfico va desde 192.168.45.0/24 hacia 192.168.84.0/24, coincide con la política.
5. El crypto map activa la negociación IKEv1 con R2.
6. R1 y R2 negocian los parámetros de seguridad usando IKEv1.
7. Luego IPSec protege el tráfico real usando ESP.
8. El tráfico viaja cifrado por medio del ISP.
9. R2 recibe el tráfico, lo descifra y lo entrega a la LAN B.
10. PC-B responde usando el mismo proceso en sentido contrario.
...
Ojo: revisa que los nombres de las imágenes en tu carpeta `images` sean exactamente iguales a los que están escritos aquí. Si una imagen tiene otro nombre, GitHub no la va a mostrar.
```
